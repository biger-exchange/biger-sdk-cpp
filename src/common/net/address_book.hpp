...
**
**    Author        : bd@biger.in
**    File          : address_book.hpp
**    Date          : 2018/07/26 12:02:00
**    Description   : Address Book
**
****************************************************************************/

#ifndef BIGER_COMMON_NET_ADDRESS_BOOK_H
#define BIGER_COMMON_NET_ADDRESS_BOOK_H
...
class AddressBook
{
 ...
 public:
  ...
  AddressBook(Book&& book)
    : index_{static_cast<uint32_t>(book.size() - 1)},
      book_{std::forward<Book>(book)}
  {
    Validate();
  }
